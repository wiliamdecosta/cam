 ...
 *
 */
class R_bil_currency extends Abstract_model {
    ...
    public $selectClause    = "currency_code,
                                jml_bulan_n,
                                jml_bulan_n_1,
                                jml_growth
                                ";
    public $fromClause      = "(    select s01 as currency_code,
                                            n01 as jml_bulan_n,
                                            n02 as jml_bulan_n_1,
                                            n03 as jml_growth
                                    from table(pack_report.rep_billing_per_currency(%s,%s,null,''))
                                )";
