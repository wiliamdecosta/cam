                            ...
                            <div class="form-horizontal">
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="customer_ref" id="customer_ref" readonly>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-5">Account Number <span class="required">  * </span>
                                        </label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-5">Account Name
                                        </label>
                                        <div class="col-md-6">
...
<script>
    ...
    $.ajax({
        url: '<?php echo WS_JQGRID."account.detailaccount_controller/read_detail_acc"; ?>',
        type: "POST",
        dataType: "json",
        data: {
            account_num: "<?php echo $this->input->post('account_num'); ?>"
