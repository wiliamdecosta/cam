...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."account.detailaccount_controller/read_add_info"; ?>',
            datatype: "json",
            mtype: "POST",
            postData: { 
                account_num: "<?php echo $this->input->post('account_num');?>"
            ...
            colModel: [
                {label: 'Business Share',name: 'business_share',width: 150, align: "left",editable: false, hidden:false },
                {label: 'NPWP',name: 'npwp',width: 150, align: "left",editable: false, hidden:false },
                {label: 'Is Monthly Invoice',name: 'is_monthly_invoice',width: 150, align: "left",editable: false,
                ...
                {label: 'Sap Account',name: 'sap_account',width: 200, align: "left",editable: false }
            ],
            height: '100%',
            autowidth: true,
            viewrecords: true,
