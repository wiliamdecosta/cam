        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red bold uppercase"> List Of Billing Complete per Area
                    </span>
                </div>
            </div>
            <!-- CONTENT PORTLET -->
...
<script>
    jQuery(function ($) {
        var grid_selector = "#grid-table-billing-complete-area";
        var pager_selector = "#grid-pager-biliing-complete-area";

        jQuery("#grid-table-billing-complete-area").jqGrid({
            ...
            sortorder: '',
            pager: '#grid-pager-biliing-complete-area',
            jsonReader: {
                root: 'rows',
                id: 'id',
                repeatitems: false
            ...
            //editurl: '<?php echo WS_JQGRID . "report.r_bil_complete_area_controller/read"; ?>',
            caption: "Billing Complete Area"
    ...
    $('#cari_account').click(function () {
            alert();
            var myGrid = jQuery("#grid-table-billing-complete-area").jqGrid({
