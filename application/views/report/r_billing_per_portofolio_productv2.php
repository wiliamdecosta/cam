  ...
  <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <table id="table-bill-per-portofolio" class="table table-bordered">
                        <thead>
                        <tr>
                            <th class="red">Area</th>
                            <th class="red">Portofolio</th>
                            <th class="red">Jumlah Bill Bulan N</th>
                            <th class="red">Jumlah Bill Bulan N-1</th>
...
<script>
    ...
    $("#btn-search").on('click', function() {
        ...
        var url =  '<?php echo WS_JQGRID . "report.r_billing_per_portofolio_product_controller/tableBillPerPortofolioProduct"; ?>';
        $.ajax({
            type: "POST",
            url: url,
