...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Billing per Portofolio Product</span>
             <i class="fa fa-circle"></i>
        </li>
    </ul>
</div>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red bold uppercase"> List Of Billing per Portofolio Product
                    </span>
                </div>
            </div>
            <!-- CONTENT PORTLET -->
...
<script>
    jQuery(function ($) {
        var grid_selector = "#grid-table-billing-per-portofolio-product";
        var pager_selector = "#grid-pager-billing-per-portofolio-product";

        jQuery("#grid-table-billing-per-portofolio-product").jqGrid({
            url: '<?php echo WS_JQGRID . "report.r_billing_per_portofolio_product_controller/read"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                {
            ...
            sortorder: '',
            pager: '#grid-pager-billing-per-portofolio-product',
            jsonReader: {
                root: 'rows',
                id: 'id',
                repeatitems: false
            ...
            //editurl: '<?php echo WS_JQGRID . "report.r_billing_per_portofolio_product_controller/read"; ?>',
            caption: "Billing per Portofolio Product"

        });

        jQuery('#grid-table-billing-per-portofolio-product').jqGrid('navGrid', '#grid-pager-billing-per-portofolio-product',
            {   //navbar options
                edit: false,
                excel: true,
    ...
    function toExcelAccount() {
        ...
        url += "&searchOper=" + $("#grid-table-billing-per-portofolio-product").getGridParam("postData").searchOper;
        url += "&searchString=" + $("#grid-table-billing-per-portofolio-product").getGridParam("postData").searchString;
        url += "&periode=" + $("#grid-table-billing-per-portofolio-product").getGridParam("postData").periode;
        window.location = url;
    }

    $('#cari_account').click(function () {
            alert();
            var myGrid = jQuery("#grid-table-billing-per-portofolio-product").jqGrid({
...
<script>
    ...
    $("#btn-search").on('click', function() {
        ...
        //alert(periode);
        $('#grid-table-billing-per-portofolio-product').jqGrid('setGridParam', {
            url: '<?php echo WS_JQGRID . "report.r_bc_per_portofolio_product_controller/read"; ?>',
            postData: {periode: periode}
        });

        $('#grid-table-billing-per-portofolio-product').jqGrid('setCaption', 'Billing Complete Area :: ' + periode);
        $("#grid-table-billing-per-portofolio-product").trigger("reloadGrid");
    });
