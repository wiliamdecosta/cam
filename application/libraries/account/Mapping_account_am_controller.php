 ...
 */
class Mapping_account_am_controller
{
    function read() {
        ...
        try {
            ...
            $ci->load->model('account/mapping_account_am');
            $table = $ci->mapping_account_am;
            ...
            // Filter Table
            /*$req_param['where'] = array(" bill_status in (1,7,8) 
                                          AND bill_dtm between to_date('".$start_dat."','yyyy-mm-dd') 
    ...
    function crud() {
        ...
        switch ($oper) {
            ...
            default :
                //permission_check('view-mapping_account_am');
                $data = $this->read();
            break;
        }
